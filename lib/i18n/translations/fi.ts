const fi = {
  ...
  topup_title:'Sinulla on jo eSIM?', topup_sub:'Lisää dataa sekunneissa.', topup_cta:'Lisää nyt',
  tariffs_title:'Kaikki paketit', tariffs_sub:'Löydä paras paketti matkakohteellesi', tariffs_search:'Hae maata tai aluetta…', tariffs_filter_all:'Kaikki', tariffs_filter_travel:'Travel', tariffs_filter_eco:'Unlimited Eco', tariffs_filter_pro:'Unlimited Pro', tariffs_empty:'Paketteja ei löytynyt.', tariffs_empty_sub:'Kokeile toista hakua.',
  checkout_title_new:'Osta eSIM', checkout_title_topup:'Lisää dataa eSIM:iin', checkout_plan:'Paketti', checkout_data:'Data', checkout_validity:'Voimassaolo', checkout_days:'päivää', checkout_iccid:'ICCID', checkout_total:'Yhteensä', checkout_email_label:'Sähköpostiosoite', checkout_email_ph:'sinun@email.fi', checkout_email_hint:'eSIM-tietosi lähetetään tähän osoitteeseen.', checkout_submit:'Osta nyt hintaan', checkout_loading:'Ohjataan…', checkout_secure:'🔒 Turvallinen maksu Sellauthilla',
  topup_page_title:'Lisää dataa eSIM:iin', topup_page_sub:'Syötä ICCID ja valitse lisäpaketti.', topup_iccid_label:'eSIM:si ICCID', topup_iccid_ph:'esim. 8949xxxxxxxxxxxxxx', topup_iccid_hint:'Löydät ICCID:n puhelimen eSIM-asetuksista tai tilausvahvistuksesta.', topup_search:'Hae', topup_searching:'…', topup_results_for:'Saatavilla olevat paketit ICCID:lle', topup_no_results:'Lisäpaketteja ei löytynyt.', topup_no_results_sub:'Tarkista ICCID ja yritä uudelleen.', topup_btn:'Lisää dataa',
  login_welcome:'Tervetuloa takaisin', login_sub:'Kirjaudu hallitaksesi eSIM-korttejasi.', login_email:'Sähköposti', login_password:'Salasana', login_submit:'Kirjaudu', login_loading:'Kirjaudutaan…', login_no_account:'Ei tiliä?', login_register:'Rekisteröidy',
  register_title:'Luo tili', register_sub:'Hallitse kaikkia eSIM-korttejasi yhdessä paikassa.', register_email:'Sähköpostiosoite', register_email_ph:'sinun@email.fi', register_pw:'Salasana', register_pw_ph:'Valitse turvallinen salasana', register_submit:'Luo tili', register_loading:'Luodaan tiliä…', register_has_account:'Oletko jo rekisteröitynyt?', register_login:'Kirjaudu', register_success_title:'Vahvista sähköpostisi', register_success_sub:'Lähetimme vahvistuslinkin osoitteeseen {email}.', register_success_back:'Takaisin kirjautumiseen',
  pw_rule_length:'Vähintään 8 merkkiä', pw_rule_upper:'Vähintään 1 iso kirjain', pw_rule_lower:'Vähintään 1 pieni kirjain', pw_rule_number:'Vähintään 1 numero', pw_rule_special:'Vähintään 1 erikoismerkki', pw_weak:'Erittäin heikko', pw_fair:'Heikko', pw_medium:'Kohtalainen', pw_strong:'Vahva', pw_very_strong:'Erittäin vahva',
  dash_title:'eSIM-korttini', dash_new_esim:'+ Uusi eSIM', dash_orders:'Tilaukset', dash_active:'Aktiiviset', dash_spent:'Yhteensä käytetty', dash_pending:'⏳ Käsitellään', dash_my_esims:'📱 eSIM-korttini', dash_empty:'Ei tilauksia vielä', dash_empty_cta:'Osta ensimmäinen eSIM →', dash_topup:'📶 Lisää dataa', dash_details:'Tiedot →',
